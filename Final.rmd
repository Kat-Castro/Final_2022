...
The effectiveness is now used for the covid-19 vaccine within Males. If the result comes out to be above 50%, that means the vaccine becomes effective. Looking at our result, we can conclude that the vaccine is effective for men when trying not to contract covid-19. The odds ratio can also show how effective the vaccine is. Our collected odds ration is 17.
